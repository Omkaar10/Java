...
public class Point {
    ...
    {
        double calcDistance= Math.sqrt(((x-0.0)*(x-0.0))+((y-0.0)*(y-0.0)));
        return calcDistance;
    }

    public double distance(Point point)
    {
        double calcDistance = Math.sqrt(((x-point.x)*(x-point.x))+((y-point.y)*(y-point.y)));
        return calcDistance;
    }

    public double distance(int new_X, int new_Y)
    {
        double calcDistance= Math.sqrt(((x-new_X)*(x-new_X))+((y-new_Y)*(y-new_Y)));
        return calcDistance;
    }
